...
public class BancoDados {
	...
	private static final String[] SCRIPT_DATABASE_CREATE = new String[] {
			"CREATE TABLE tbl_cadastro(_id integer primary key, usuario text,email text,senha text);","CREATE TABLE tbl_grupo(_id integer primary key,nomeDoGrupo text,monitorResponsavel text,localDeAtuacao text,descricaoDasAtividades);"
