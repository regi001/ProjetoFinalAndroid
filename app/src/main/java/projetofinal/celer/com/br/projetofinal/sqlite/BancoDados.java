...
public class BancoDados {
	...
	private static final String[] SCRIPT_DATABASE_CREATE = new String[] {
			"CREATE TABLE tbl_cadastro(usuario text primary key,  email text, senha text);","CREATE TABLE tbl_grupo(_id integer primary key,  nomeDoGrupo text, monitorResponsavel text,localDeAtuacao text,descricaoDasAtividades);"
